...
🛒 Amazon Sales Dashboard <br>
An interactive Power BI dashboard designed to analyze Amazon sales performance across different regions, categories, segments, shipping modes, and states—helping businesses uncover sales trends, profitability insights, and operational performance.

2. Short Description 

The Amazon Sales Dashboard is a dynamic and visually engaging Power BI report created to monitor and analyze sales data from Amazon across multiple business dimensions. The dashboard helps users track sales performance, identify high-performing categories and regions, analyze customer segments, and gain actionable business insights for better decision-making.

3. Tech Stack

The dashboard was built using the following tools and technologies:<br>

• 📊 Power BI Desktop – Main platform used for creating interactive reports and visualizations.<br>
• 📂 Power Query – Used for data cleaning, transformation, and preprocessing.<br>
• 🧠 DAX (Data Analysis Expressions) – Implemented for calculated measures, KPIs, and dynamic aggregations.<br>
• 📝 Data Modeling – Relationships established between sales-related tables for filtering and analysis.<br>
• 📈 Data Visualization Techniques – Donut charts, bar charts, KPI cards, and slicers used for storytelling and analytics.<br>
• 📁 File Formats – .pbix for development and .png for dashboard previews.

4. Data Source

Source: Amazon Sales Dataset (Sample Superstore/Amazon retail sales data).
